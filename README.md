...
+ Amber Bishop wrote the code for effects.py, ent_ai.py, extras.py, image_loader.py, inspect_charecter.py, helper_funcs.py, fixed a vast majority of the bugs, wrote the enemy AI, created all of the features in the extras tab, and helped heavily with the ideas for how the code should function. She was the lead programmer.     
...
+ Amber: I'm a 10th grader at UCAS, who enjoys coding, and game design. My dream job is to work Valve. You can contact me at mark.bishop@ucas-edu.net
